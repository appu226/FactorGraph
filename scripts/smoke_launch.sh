...
blif_solve/blif_solve --verbosity INFO --under_approximating_method AcyclicViaForAll --over_approximating_method FactorGraphApprox --var_node_merge_limit 100 --diff_output_path temp/6s365r_bdd.dimacs test/data/6s365r_bdd.blif | sed "s/^/[6s365r_bdd] /"
(exit ${PIPESTATUS[0]})
